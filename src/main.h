...
Dai calcoli risulta che Trise - Tfall = 20 e cio� 80 us (1 Hall counter step e' 4us).
Quindi Trise � molto pi� lungo di Tfall. Quindi le transizioni del sensore Hall vengono rilevate
...
visto che � partito con 80us di ritardo rispetto agli altri stati. In questo modo
il contatore Hall sar� allineato allo stesso modo per tutti gli stati, ma sar� comunque in ritardo
di Tfall per tutti gli stati. Questo ritardo fisso viene gestito con un offset fisso da sommare
al contatore. Questo spiega la necessit� dell'offset fisso che si � reso necessario fino ad ora.
Visto che il valore attuale dell'offset fisso � 18, si deve sommare 28 (20+8) agli stati 6,3,5
e 8 agli stati 2,1,4 poich� (28+8)/2=18. Di questo 8 (8x4=32us), 6,5 (6,56*4=26,25us) servono a
...
Purtroppo non c'� modo di calcolare i valori assoluti di Trise e Tfall utilizzando i contatori
Hall ma solo la differenza fra i due valori.
In realt� sarebbe possibile misurando con precisionea la corrente a diverse velocit� prestabilite
del motore. Mantenedo fissa la velocit� si fa variare il duty cycle, e l'offset del contatore hall
e si trova il valore di offset per cui la corrente assorbita � minima per una data velocita.
...
Il problema � che la misura di corrente fornita dal controller � troppo grossolana e si dovrebbe
